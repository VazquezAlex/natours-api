...
const createSendToken = (user, statusCode, res) => {
    ...
    const cookieExpiresInMs =  process.env.JWT_COOKIE_EXPIRES_IN * 24 * 60 * 60 * 1000;
    const cookieOptions = {
        expires: new Date(Date.now() + cookieExpiresInMs),
        // secure: true,   // Only be sent on https, turn on only on production.
        httpOnly: true, // Only accesible through http methods.
    }
